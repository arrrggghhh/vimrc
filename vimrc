...
" =============================================================================
" GUI: MacVim/gvim 폰트 설정
" - 목적: GUI 환경에서 가독성 확보를 위해 폰트와 크기 지정
" =============================================================================
if has('gui_running')
...
" =============================================================================
" UI: 컬러 스키마 고정
" - 목적: 내장 colorscheme `desert`를 항상 사용
" =============================================================================
colorscheme desert

" =============================================================================
" 파일: 스왑 파일을 특정 디렉토리에 모아서 관리
" - 목적: 스왑 파일을 한 곳에 모아 정리/청소/백업을 쉽게 함
" - 기본값: ~/.vim/swap//
" - 커스터마이즈: vimrc에 `let g:swap_dir = '...'`로 변경 가능
" - 참고: `//`는 파일명 충돌을 줄이고 하위 경로를 안전하게 처리하는 관용적 방식
" =============================================================================
let g:swap_dir = get(g:, 'swap_dir', expand('~/.vim/swap'))
if !isdirectory(g:swap_dir)
  call mkdir(g:swap_dir, 'p', 0700)
endif
execute 'set directory=' . fnameescape(g:swap_dir) . '//'
